...
ti.targets.arm.elf.M4F.rootDir ?= C:/ti/ccsv7/tools/compiler/ti-cgt-arm_16.9.4.LTS
...
package/%.xdc.inc package/%_xconfig_Robot.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package xconfig_Robot" (because $@ is older than $(firstword $?))" ...
	$(XSRUN) -f xdc/services/intern/cmd/build.xs $(MK_IDLOPTS) -m package/package.xdc.dep -i package/package.xdc.inc package.xdc

.dlls,em4f .dlls: Robot.pem4f

-include package/cfg/Robot_pem4f.mak
-include package/cfg/Robot_pem4f.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/Robot_pem4f.dep
endif
Robot.pem4f: package/cfg/Robot_pem4f.xdl
	@


ifeq (,$(wildcard .libraries,em4f))
Robot.pem4f package/cfg/Robot_pem4f.c: .libraries,em4f
endif

package/cfg/Robot_pem4f.c package/cfg/Robot_pem4f.h package/cfg/Robot_pem4f.xdl: override _PROG_NAME := Robot.xem4f
package/cfg/Robot_pem4f.c: package/cfg/Robot_pem4f.cfg
package/cfg/Robot_pem4f.xdc.inc: package/cfg/Robot_pem4f.xdl
package/cfg/Robot_pem4f.xdl package/cfg/Robot_pem4f.c: .interfaces

clean:: clean,em4f
	-$(RM) package/cfg/Robot_pem4f.cfg
	-$(RM) package/cfg/Robot_pem4f.dep
	-$(RM) package/cfg/Robot_pem4f.c
	-$(RM) package/cfg/Robot_pem4f.xdc.inc

clean,em4f::
	-$(RM) Robot.pem4f
.executables,em4f .executables: Robot.xem4f

Robot.xem4f: |Robot.pem4f

-include package/cfg/Robot.xem4f.mak
Robot.xem4f: package/cfg/Robot_pem4f.oem4f 
	$(RM) $@
	@$(MSG) lnkem4f $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.arm.elf.M4F.rootDir)/bin/armcl -fs $(XDCCFGDIR)$(dir $@). -q -u _c_int00 --silicon_version=7M4 -z --strict_compatibility=on  -o $@ package/cfg/Robot_pem4f.oem4f   package/cfg/Robot_pem4f.xdl  -w -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.arm.elf.M4F.rootDir)/lib/libc.a
	
Robot.xem4f: export C_DIR=
Robot.xem4f: PATH:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)
Robot.xem4f: Path:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)

Robot.test test,em4f test: Robot.xem4f.test

Robot.xem4f.test:: Robot.xem4f
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 Robot.xem4f.test
else
	@$(MSG) running $<  ...
	$(call EXEC.Robot.xem4f, ) 
endif

clean,em4f::
	-$(RM) $(wildcard .tmp,Robot.xem4f,*)
...
%,copy:
	...
	$(RM) $@
	$(CP) $< $@
Robot_pem4f.oem4f,copy : package/cfg/Robot_pem4f.oem4f
Robot_pem4f.sem4f,copy : package/cfg/Robot_pem4f.sem4f

$(XDCCFGDIR)%.c $(XDCCFGDIR)%.h $(XDCCFGDIR)%.xdl: $(XDCCFGDIR)%.cfg $(XDCROOT)/packages/xdc/cfg/Main.xs | .interfaces
	@$(MSG) "configuring $(_PROG_NAME) from $< ..."
	$(CONFIG) $(_PROG_XSOPTS) xdc.cfg $(_PROG_NAME) $(XDCCFGDIR)$*.cfg $(XDCCFGDIR)$*

.PHONY: release,xconfig_Robot
ifeq (,$(MK_NOGENDEPS))
-include package/rel/xconfig_Robot.tar.dep
endif
package/rel/xconfig_Robot/xconfig_Robot/package/package.rel.xml: package/package.bld.xml
package/rel/xconfig_Robot/xconfig_Robot/package/package.rel.xml: package/build.cfg
package/rel/xconfig_Robot/xconfig_Robot/package/package.rel.xml: package/package.xdc.inc
package/rel/xconfig_Robot/xconfig_Robot/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

xconfig_Robot.tar: package/rel/xconfig_Robot.xdc.inc package/rel/xconfig_Robot/xconfig_Robot/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/xconfig_Robot.xdc.inc,package/rel/xconfig_Robot.tar.dep)


release release,xconfig_Robot: all xconfig_Robot.tar
clean:: .clean
	-$(RM) xconfig_Robot.tar
	-$(RM) package/rel/xconfig_Robot.xdc.inc
	-$(RM) package/rel/xconfig_Robot.tar.dep
